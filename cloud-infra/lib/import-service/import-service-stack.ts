...
function createImportProductsFileLambda(scope: cdk.Stack, importBucket: s3.Bucket, uploadedFolderName: string) {
...
function createApiGateway(scope: cdk.Stack, importProductsFileLambda: lambda.Function) {
...
export class ImportServiceStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        const importProductsFileLambda = createImportProductsFileLambda(this, importBucket, uploadedFolderName);
        createApiGateway(this, importProductsFileLambda);
        createImportFileParserLambda(this, importBucket, uploadedFolderName, parsedFolderName);
    }
}